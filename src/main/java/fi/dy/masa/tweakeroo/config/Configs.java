...
public class Configs implements IConfigHandler
{
    ...
    public static class Generic
    {
        ...
        public static final ConfigInteger       MORE_EMPTY_BUCKETS                  = new ConfigInteger     ("tweakMoreEmptyBuckets",1, 1, 64, "Enables empty buckets to stack to 64.\nNOTE: They will also stack inside inventories!\nOn servers this will cause desyncs/glitches\nunless the server has a mod that does the same.");
        public static final ConfigInteger       MORE_ENDER_PEARLS                   = new ConfigInteger     ("tweakMoreEnderPearls",1, 1, 64, "Enables ender perals to stack to 64.\nNOTE: They will also stack inside inventories!\nOn servers this will cause desyncs/glitches\nunless the server has a mod that does the same.");
