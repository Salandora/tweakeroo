...
public class Configs implements IConfigHandler
{
    ...
    public static class Generic
    {
        ...
        public static final ConfigInteger       SHULKERBOX_STACKING                 = new ConfigInteger     ("shulkerBoxesStack", 1, 1, 64,"Enables shulker boxes stacking up to 64.\nNOTE: They will also stack inside inventories!\nOn servers this will cause desyncs/glitches\nunless the server has a mod that does the same.\nIn single player this changes shulker box based system behaviour.");
        public static final ConfigInteger       POTION_STACKING                     = new ConfigInteger     ("potionStack", 1, 1, 64, "Enables Potion stacking up to 64.\nNOTE: They will also stack inside inventories!\nOn servers this will cause desyncs/glitches\nunless the server has a mod that does the same.");
        public static final ConfigInteger       MINECART_STACKING                   = new ConfigInteger     ("tweakMinecartStack",1, 1, 64, "Enables Minecart stacking up to 16.\nNOTE: They will also stack inside inventories!\nOn servers this will cause desyncs/glitches\nunless the server has a mod that does the same.");
        public static final ConfigInteger       FILLED_BUCKETS_STACKING             = new ConfigInteger     ("tweakFilledBucktesStack",1, 1, 64, "Enables filled buckets to stack to 64.\nNOTE: They will also stack inside inventories!\nOn servers this will cause desyncs/glitches\nunless the server has a mod that does the same.");
        public static final ConfigInteger       MORE_EMPTY_BUCKETS                  = new ConfigInteger     ("tweakMoreEmptyBuckets",16, 1, 64, "Enables empty buckets to stack to 64.\nNOTE: They will also stack inside inventories!\nOn servers this will cause desyncs/glitches\nunless the server has a mod that does the same.");
        public static final ConfigInteger       MORE_ENDER_PEARLS                   = new ConfigInteger     ("tweakMoreEnderPearls",16, 1, 64, "Enables ender perals to stack to 64.\nNOTE: They will also stack inside inventories!\nOn servers this will cause desyncs/glitches\nunless the server has a mod that does the same.");
