...
public enum FeatureToggle implements IHotkeyTogglable, IConfigNotifiable<IConfigBoolean>
{
    ...
    TWEAK_POTION_STACKING           ("tweakPotionStack",                    false, "",    "Enables Potion stacking up to 64.\nNOTE: They will also stack inside inventories!\nOn servers this will cause desyncs/glitches\nunless the server has a mod that does the same."),
    TWEAK_MINECART_STACKING         ("tweakMinecartStack",                  false, "",    "Enables Minecart stacking up to 16.\nNOTE: They will also stack inside inventories!\nOn servers this will cause desyncs/glitches\nunless the server has a mod that does the same."),
    TWEAK_FILLED_BUCKETS_STACKING   ("tweakFilledBucktesStack",             false, "",    "Enables filled buckets to stack to 64.\nNOTE: They will also stack inside inventories!\nOn servers this will cause desyncs/glitches\nunless the server has a mod that does the same."),
    TWEAK_MORE_EMPTY_BUCKETS        ("tweakMoreEmptyBuckets",               false, "",    "Enables empty buckets to stack to 64.\nNOTE: They will also stack inside inventories!\nOn servers this will cause desyncs/glitches\nunless the server has a mod that does the same."),
    TWEAK_MORE_ENDER_PEARLS         ("tweakMoreEnderPearls",                false, "",    "Enables ender perals to stack to 64.\nNOTE: They will also stack inside inventories!\nOn servers this will cause desyncs/glitches\nunless the server has a mod that does the same."),
    ...
    TWEAK_PLACEMENT_REST_DOUBLE_SLAB("tweakPlacementRestrictionDoubleSlab", false, "",    "Restricts block placement so that slabs will not double up"),
    ...
    TWEAK_NO_PUMPKIN_OVERLAY        ("tweakNoPumpkinOverlay",               false, "",    "Disables the pumpkin overlay while wearing a pumpkin head");
